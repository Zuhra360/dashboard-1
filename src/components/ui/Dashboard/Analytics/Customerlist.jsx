...
import  arrow from '../../../../assets/images/Arrow - Down 2.png'
                           ...
                           <Popover width={150} position="bottom-right" withArrow shadow="lg">
                                ...
                                <Popover.Dropdown>
                                  <Flex  direction={'column'} gap={3}>
                                    <Flex className='bg-blue-50 text-blue-500 text-sm font-semibold p-2 rounded-md gap-4'>
                                        <IconEdit size={18}/>
                                        Edit
                                    </Flex>
                                    <Flex className='bg-red-50 text-red-500  text-sm font-semibold p-2 rounded-md gap-4'>
