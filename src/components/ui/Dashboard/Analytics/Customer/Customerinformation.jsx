...
function Customerinformation() {
  ...
  return (
    <div className='basis-3/12 w-full h-full bg-white p-6 flex flex-col gap-5'>
        ...
        <div className='basis-4/12 flex flex-col justify-end items-start'>
          <p className='text-2xl flex-grow flex justify-end flex-col pb-3 text-gray-600 font-semibold'>Contact Info</p>
          ...
          <div className='gap-5 pt-5 flex-1 flex flex-col  w-full'>
            <div className='flex gap-2 items-center text-gray-400 hover:text-gray-600'>
              <IconMailFilled/><p className='text-sm'>kajope5182@ummoh.com</p>
              </div>
            <Divider/>
          </div> 
          ...
          <div className='gap-5 pt-5 flex-1 flex flex-col  w-full'>
            <div className='flex gap-2 items-center text-gray-400 hover:text-gray-600'>
              <IconMapPinFilled /><p className='text-sm'>2239  Hog Camp Road Schaumburg</p>
              </div>
            <Divider/>
          </div>  
        </div>
