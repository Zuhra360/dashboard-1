        ...
        <div className=" flex-grow rounded  bg-gray-50">
          <table className=" rounded p-2 w-full h-full gap-3">
            <thead>
              <tr className="">
                <td>
                  <p className=" text-sm text-gray-700 pl-3 py-3">
                    Tracking no
                  </p>
                </td>
                <td >
                ...
                <td >
                  <p className="text-sm text-gray-700">Total Order</p>
                </td>
                <td >
              ...
              {orderdetailsdata.map((items) => {
                return (
                  <tr className=" hover:bg-gray-100 p-2" key={items.trackingno}>
                    ...
                    <td>
                      <div className="w-16 h-8 bg-blue-100 rounded flex items-center justify-center text-blue-500 font-bold">
                        {items.totalorders}
                      </div>
                    </td>
